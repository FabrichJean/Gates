import { FilePlus, Eye, Filter, Edit, X, CheckSquare, Square, Users } from "lucide-react";
              ...
              <tr>
                {selectionMode && (
                  <th scope="col" className="px-6 py-3">
                    <input
                      type="checkbox"
                      checked={visibleSelectedPosts.size === filteredPosts.length && filteredPosts.length > 0}
              ...
              {filteredPosts.map((post: any, idx: number) => (
                <tr
                  ...
                  className={`bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 transition-colors ${
                    selectionMode && visibleSelectedPosts.has(post.id) 
                      ? 'bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800' 
                      : ''
                  } ${
                    selectionMode ? 'hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer' : ''
                  }`}
                ...
                >
                  {selectionMode && (
                    <td className="px-6 py-4" onClick={(e) => e.stopPropagation()}>
                      <input
                        type="checkbox"
                        checked={visibleSelectedPosts.has(post.id)}
                  ...
                  <td className="flex justify-center gap-2 px-6 py-4" onClick={(e) => e.stopPropagation()}>
                    {user?.role === RoleEnum.SUPERADMIN ? (
                      <>
