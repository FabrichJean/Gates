...
export default function CreatorManager() {
  ...
  const {
    ...
    reFetch,
    pagination,
  } = UseCreators({ page, limit, q: query });
              ...
              <div className="mb-3 flex items-center justify-between gap-3">
                <div className="relative flex-1">
                  <input
                    ...
                    className={`w-full pr-8 px-3 h-10 rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 ${
                ...
                <button
                  ...
                  disabled={isLoading}
                  className={`ml-3 px-3 h-10 flex items-center justify-center rounded-md bg-indigo-600 text-white text-sm ${
                    ...
                    return pages.map((pnum, idx) => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-3 py-1 h-8 flex items-center justify-center rounded ${
                            pnum === (pagination?.page ?? page)
