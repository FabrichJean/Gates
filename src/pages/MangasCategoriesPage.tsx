      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        >
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Rechercher des catégories ou sous-catégories..."
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="w-full pl-10 pr-10 py-2.5 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
            />
            {searchTerm && (
              <button
        ...
        >
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-gray-500 dark:text-gray-400">Sous-catégories</p>
                <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">
