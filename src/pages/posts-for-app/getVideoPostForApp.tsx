...
import type { Video } from "../../hooks/usePostForApp";
...
const VideoStatusBadge: React.FC<{ status: string; label: string }> = ({ status, label }) => {
...
export default function GetVideoPostForApp({ videos, reFetch }: Props) {
