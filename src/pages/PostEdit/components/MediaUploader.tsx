...
export default function MediaUploader(props: {
  ...
  videoFields: { id: number; file: File | null; url?: string }[];
  ...
  const { images, videos, imageFields, videoFields, handleImageChange, handleVideoChange, addImageField, addVideoField, removeImageField, removeVideoField, setDeletedImageIds, setDeletedVideoIds, setMedia } = props;
