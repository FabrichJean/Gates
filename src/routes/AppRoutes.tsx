                ...
                <MangasProvider>
                  <MangaUploadSocketProvider>
                    <Routes>
                      ...
                      <Route
                        path=":mangaId/edit"
                        element={<EditMangasPage />}
                      />
                      <Route
                        path=":mangaId/chapters"
                        element={<MangaChaptersRouteWrapper />}
                      />
                      <Route
                        path=":mangaId/chapters/:chapterId/edit"
                        element={<EditMangasChapterPage />}
                      />
                      <Route
                        path=":mangaId/chapters/:chapterId/episodes/upload"
                        element={<UploadMangasEpisodePage />}
                      />
                      <Route
                        path=":mangaId/chapters/:chapterId/episodes"
                        element={<MangasEpisodesPage />}
                      />
                      <Route
                        path=":mangaId/chapters/:chapterId/episodes/:episodeId"
                        element={<MangasEpisodeDetailsPage />}
                      />
                      <Route
                        path=":mangaId/chapters/:chapterId/episodes/:episodeId/edit"
                        element={<EditMangasEpisodePage />}
                      />
                    </Routes>
                  </MangaUploadSocketProvider>
                </MangasProvider>
                ...
                <InsideSidebar>
                  <AudiosProvider>
                    <Routes>
                      ...
                      <Route
                        path="albums/upload"
                        element={<UploadAudioAlbum />}
                      />
                      <Route
                        path="albums/:id"
                        element={<AudioAlbumDetails />}
                      />
                      <Route
                        path="albums/:id/edit"
                        element={<AudioAlbumEdit />}
                      />
                    </Routes>
                  </AudiosProvider>
                </InsideSidebar>
