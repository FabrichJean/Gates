                            ...
                            <Link to="/archive" onClick={() => handleNav("archive")} className={linkClass("archive")}>
                                ...
                                <svg
                                    ...
                                    <path
                                        ...
                                        2.118H6.622a2.25 2.25 0 0 1-2.247-2.118L3.75 
                                        7.5M10 11.25h4M3.375 7.5h17.25c.621 
                                        0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-
                                        1.125H3.375c-.621 0-1.125.504-1.125 
