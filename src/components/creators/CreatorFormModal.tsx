      ...
      <div className="relative z-10 w-full max-w-2xl p-6 bg-white dark:bg-gray-800 rounded-lg shadow-2xl">
        <div className="flex items-center justify-between mb-4">
          <h4 className="text-lg font-semibold text-gray-900 dark:text-white">
            {creator ? "Edit creator" : "Create creator"}
          </h4>
        ...
        <div className="grid grid-cols-3 gap-6 items-start">
          <div className="col-span-1 flex flex-col items-center gap-3">
            ...
            <label
              className={`mt-1 inline-flex items-center px-3 py-1 rounded-md border border-gray-200 dark:border-gray-700 text-sm bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-200 ${
          ...
          <div className="col-span-2">
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <button
                onClick={onClose}
                disabled={isLoading}
                className={`px-4 py-2 rounded-md text-sm text-gray-600 dark:text-gray-300 ${
                  isLoading ? "opacity-60 pointer-events-none" : ""
                }`}
              >
                Cancel
