import { MdOutlineVerifiedUser, MdDelete, MdDeleteOutline } from "react-icons/md";
      ...
      <div className="w-full pb-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 w-full">
          {items.map((creator) => (
            <div
              key={creator.id}
              className="w-full bg-white dark:bg-slate-700 rounded-lg p-4 flex flex-col items-start transition-all hover:shadow-lg border border-gray-200 dark:border-gray-500"
