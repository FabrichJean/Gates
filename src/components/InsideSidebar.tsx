...
{/* 
                            ...
                            <a
                                href="/app/projects"
                                className="flex flex-row items-center justify-center lg:justify-start rounded-md h-12 pr-3.5 lg:pr-6 bg-primary-50 shadow-sm text-primary-400 font-bold"
                            >
                                <span className="ml-0 lg:ml-2 text-sm tracking-wide truncate capitalize hidden lg:block">
                                    Projects
                                </span>
