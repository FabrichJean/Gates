...
export const ProfessionalFileExplorer: React.FC = () => {
  ...
  // Get breadcrumb path
  const breadcrumbPath = useMemo(() => getBreadcrumbPath(currentNode), [currentNode]);
  ...
  const handleFileClick = useCallback((fileNode: FileTreeNode) => {
      ...
      <div className="flex items-center justify-between p-3 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="relative">
            ...
            />
            <svg className="absolute right-2 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400" 
  ...
  return (
    <div className="p-4 grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 xl:grid-cols-10 gap-3">
      {node.children.map((child) => {
        const isSelected = child.fileRecord && selectedFiles.has(child.fileRecord.id.toString());
        ...
        return (
          ...
          >
            ...
            <div className="text-center w-full">
              <p className="text-xs font-medium text-gray-900 dark:text-gray-100 truncate" title={child.name}>
                {child.name}
              </p>
        ...
        return (
          <div key={child.id}>
            ...
            >
              <div className="col-span-6 flex items-center space-x-3 min-w-0">
                <div className="flex items-center space-x-1">
                  {child.type === 'folder' && (
                    ...
                    >
                      <svg className={`w-3 h-3 text-gray-400 transform transition-transform ${
              ...
              <div className="col-span-2 flex items-center text-sm text-gray-500 dark:text-gray-400">
                {child.type === 'file' ? (child.extension?.toUpperCase() || 'File') : 'Folder'}
              </div>
              <div className="col-span-2 flex items-center text-sm text-gray-500 dark:text-gray-400">
